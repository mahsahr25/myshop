...
<h1 class="text-center">جدول نظرات</h1>
    ...
    <thead>
        <br>
        <br>
    <a href="{{route("admin.reviews.create")}}" class="btn btn-primary  pull-right py-3"><b>+</b> Add new comment</a>
    <br>
        <tr>
            <th>ID</th>
            <th>Comment</th>
...
{{-- </td> --}}
        ...
        <td class="text-center"><a class='btn btn-info btn-xs' href="{{url('admin/reviews/'.$review->id.'/edit')}}"></span> Edit</a>
