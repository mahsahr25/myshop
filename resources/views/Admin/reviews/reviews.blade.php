...
<br><br>
<div>
<h1 class="text-center">جدول نظرات</h1>
...
<div class="container">
    ...
    <thead>
        <br>
        <br>
    <a href="{{route("admin.product.create")}}" class="btn btn-primary  pull-right py-3"><b>+</b> Add new comment</a>
    <br>
        <tr>
            <th>ID</th>
            <th>Comment</th>
    ...
    {{-- @endforeach --}}
        ...
        <td class="text-center"><a class='btn btn-info btn-xs' href="{{url('admin/product/'.$review->id.'/edit')}}"><span class="glyphicon glyphicon-edit"></span> Edit</a>
...
{{ Form::close() }} --}}
            ...
            <form action="{{ route('admin.product.destroy', [$review->id]) }}" method="POST">
