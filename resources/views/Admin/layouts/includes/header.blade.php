...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/dist/css/bootstrap-theme.css')}}">
  <!-- Bootstrap rtl -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/dist/css/rtl.css')}}">
  <!-- persian Date Picker -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/dist/css/persian-datepicker-0.4.5.min')}}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/bower_components/font-awesome/css/font-awesome.min.css')}}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/bower_components/Ionicons/css/ionicons.min.css')}}">
  {{-- datatables --}}
  <link rel="stylesheet" href="{{asset('Admin/app-assets/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">

  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/dist/css/AdminLTE.css')}}">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/dist/css/skins/_all-skins.min.css')}}">
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/bower_components/morris.js/morris.css')}}">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/bower_components/jvectormap/jquery-jvectormap.css')}}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="{{asset('Admin/app-assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-user"></i> <span></span>کاربران</span>
            <span class="pull-left-container">
              <!-- <i class="fa fa-angle-right pull-left"></i> -->
              <i class="fa fa-angle-right pull-left"></i>
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('admin.users.index')}}"><i class="fa fa-circle-o"></i> مشاهده کاربران</a></li>
            <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> کاربران جدید</a></li>
          </ul>
        </li>
        <li class="active treeview">
                <a href="#">
                  <i class="fa fa-user"></i> <span></span>نظرات</span>
                  <span class="pull-left-container">
                    <!-- <i class="fa fa-angle-right pull-left"></i> -->
                    <i class="fa fa-angle-right pull-left"></i>
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{route('admin.reviews.index')}}"><i class="fa fa-circle-o"></i> مشاهده نظرات</a></li>
                  {{-- <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> کاربران جدید</a></li> --}}
                </ul>
              </li>
        ...
        <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>محصولات</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
          ...
          <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>دسته بندی محصولات</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> مشاهده </a></li>
              {{-- <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> کاربران جدید</a></li> --}}
            </ul>
          </li>
          <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>فاکتورها</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
          ...
          <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>تراکنش ها</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
          ...
          <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>اسلایدر</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
          ...
          <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>تخفیف ها</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
          ...
          <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>وضعیت ارسال ها</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
          ...
          <li class="active treeview">
            <a href="#">
                <i class="fa fa-box"></i> <span></span>خبرنامه</span>
              <span class="pull-left-container">
                <!-- <i class="fa fa-angle-right pull-left"></i> -->
                <i class="fa fa-angle-right pull-left"></i>
