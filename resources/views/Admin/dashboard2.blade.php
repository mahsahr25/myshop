              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    ...
                    <li>
                      <img src="{{asset('app-assets/dist/img/user6-128x128.jpg')}}" alt="User Image">
                      <a class="users-list-name" href="#">اوباما</a>
                      <span class="users-list-date">۱۵ شهریور</span>
                    </li>
                    <li>
                      <img src="{{asset('app-assets/dist/img/user2-160x160.jpg')}}" alt="User Image">
                      <a class="users-list-name" href="#">استیو جابز</a>
                      <span class="users-list-date">۳۰ شهریور</span>
                    </li>
                    <li>
                      <img src="{{asset('app-assets/dist/img/user5-128x128.jpg')}}" alt="User Image">
                      <a class="users-list-name" href="#">ادیسون</a>
                      <span class="users-list-date">۲ هفته پیش</span>
                    </li>
                    <li>
                      <img src="{{asset('app-assets/dist/img/user4-128x128.jpg')}}" alt="User Image">
                      <a class="users-list-name" href="#">شنل قرمزی</a>
                      <span class="users-list-date">۲ ماه پیش</span>
                    </li>
                    <li>
                      <img src="{{asset('app-assets/dist/img/user3-128x128.jpg')}}" alt="User Image">
...
<!-- jQuery 3 -->
<script src="{{asset('app-assets/bower_components/jquery/dist/jquery.min.js')}}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{asset('app-assets/bower_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<!-- FastClick -->
<script src="{{asset('app-assets/bower_components/fastclick/lib/fastclick.js')}}"></script>
<!-- AdminLTE App -->
<script src="{{asset('app-assets/dist/js/adminlte.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{asset('app-assets/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap  -->
<script src="{{asset('app-assets/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
<script src="{{asset('app-assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<!-- SlimScroll -->
<script src="{{asset('app-assets/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<!-- ChartJS -->
<script src="{{asset('app-assets/bower_components/Chart.js/Chart.js')}}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{asset('app-assets/dist/js/pages/dashboard2.js')}}"></script>
