        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget instafeed">
                    <h6 class="footer_title">اینستاگرام ما</h6>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6" >
                <div class="single-footer-widget f_social_wd">
                    <h6 class="footer_title">شبکه های اجتماعی</h6>
                    ...
                    <div class="f_social">
                        ...
                        <a href="#">
                            <i class="fa fa-instagram" style="margin-right:15px;"></i>
                        </a>
                        {{-- <a href="#">
...
<script src="{{asset('app-assets/js/my_js.js')}}"></script>
