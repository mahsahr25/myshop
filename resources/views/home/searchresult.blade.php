			...
			<div class="row s_product_inner">
						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
                                ...
                                {{-- <div class="carousel-item ">
                                        <img class="d-block w-100" src="{{$product->images[1]->imagename}}" alt="First slide">
                                    </div> --}}
                                {{-- @endforeach --}}
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<div class="card_area">
							<a class="main_btn" href="add_to_cart">Add to Cart</a>
					...
					{{-- <div class="row"> --}}
						...
						<div class="col-lg-6">
							<div class="review_box">
								...
								<p>Outstanding</p>
								<form class="row contact_form" action="{{url('product_review/'.$product->id)}}" method="post" id="contactForm" novalidate="novalidate">
                                 {{ csrf_field() }}
                                    <div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" name="name" placeholder="Your Full name">
